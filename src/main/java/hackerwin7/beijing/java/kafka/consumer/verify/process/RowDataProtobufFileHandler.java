...
import hackerwin7.beijing.java.kafka.consumer.verify.consume.RowDataProtobufConsume;
...
/**
 * Created by hp on 9/16/15.
 */
public class RowDataProtobufFileHandler {
    ...
    private static String kveq = null;
    ...
    public static void main(String[] args) throws Exception {
        ...
        initFile();
        RowDataProtobufConsume consume = new RowDataProtobufConsume();
        consume.setDbname(filterDb);
        consume.setTbname(filterTb);
        consume.setpKeys(priKey);
    ...
    private static void initFile() throws Exception {
        InputStream is = file2in("rowmsg-protobuf-config.properties", "config.conf");
        ...
        kveq = pro.getProperty("filter.key.value");
        is.close();
    }
